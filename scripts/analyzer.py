...
class BatteryAnalyzer:
    ...
    def __init__(self, struc_oxid, cation="Li"):
        ...
        print('cation_charge', self.cation_charge)
    ...
    def max_cation_insertion(self):
        ...
        # print('lowest_oxid', lowest_oxid.values(), lowest_oxid.keys())
        # oxid_pot = sum(
        #     [
        #         (
        #                 spec.oxi_state
        #                 - min(e for e in Element(spec.symbol).oxidation_states
        ...
        for spec in self.comp:
            ...
            if is_redox_active_intercalation(element):
                ...
                print('lowest_oxid', low)
                c_list = []
                for e in element.oxidation_states:
                    if e >= low:
                        c_list.append(e)
                c = min(c_list)
                print('c', c)
...
def is_redox_active_intercalation(element):
    ...
    ns = [
        ...
        "Sn",
        "Bi",
        "Li", "Na", "K", "Be", "Mg", "Ca", "Al", "Ga", "In", "Tl", "Y"
    ]
